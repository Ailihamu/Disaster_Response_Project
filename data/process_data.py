...
def clean_data(df):
    ...
    category_colnames = [(row[i][0])[0:-2] for i in range(36)]
    ...
    #Change it to multilabel for later model fitting and cross validation
    for cl in categories.columns:
        categories[cl] = (categories[cl]==1)*1
